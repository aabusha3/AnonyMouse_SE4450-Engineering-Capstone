...
The repositories for the capstone can be found in the [link](https://github.com/orgs/SE4450-Team12/repositories) below, the backend is no longer being hosted so this service no longer works. Hosting the backend yourself wont work either.
